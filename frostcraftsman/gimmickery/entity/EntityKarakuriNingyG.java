...
public class EntityKarakuriNingyG extends EntityAnimal{

	public EntityKarakuriNingyG(World par1World) {
		super(par1World);
		this.setSize(0.9F, 1.3F);
		// TODO Auto-generated constructor stub
	}

	public EntityKarakuriNingyG(World par1World, double par2, double par4, double par6, EntityLivingBase par8EntityLivingBase)
    {
        this(par1World);
